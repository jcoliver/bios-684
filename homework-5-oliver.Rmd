...
The study has a total of `r nrows(dental.data)` subjects, `r sum(dental.data$gender == "F")` girls and `r sum(dental.data$gender == "M")` boys. All subjects were sampled at each of four time points (). 
