...
within.var.intercept <- sd(lmm$coefficients$random$ID[, 1])^2
...
# TODO: Check this within-subject variance calculation

The within-subject variance in intercept is `r round(within.var.intercept, 3)`, while the between-subject variance in intercepts is `r round(between.var.intercept, 3)`. The greater between-subject variance suggests (to me, at least), that the fixed effects have a greater impact on intercept than does within-subject variation (random effects).
