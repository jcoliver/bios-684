...
There is very high within-subject correlation among time samples. Interestingly, the within-subject correlation does not appear to decrease much with time (e.g. the correlation coefficient between year 8 and year 10 is effectively the same as between year 8 and year 14).
...
In general, standard deviations appear to increase over time, although this is not absolute, as year 10 has the lowest standard deviation.
