...
#TODO: add i subscript to Ts

1. Link function:
$$
logit(\mu_{ij}) = \beta_1 + \beta_2 T_2 + \beta_3 T_3 + \beta_4 T_4 + \beta_5 T_3 \times X_i + \beta_6 T_4 \times X_i + \beta_7 T_5 \times X_i
$$
Where:
$$
\begin{array}{l}
...
$$
log OR(Y_{ij}, Y_{ik}|X_{ij}, X_{ik}) = \alpha_{jk}
$$
where
