...
***
#QUESTION: Are z-scores the Wald test values? Not for the question of all three week periods at once - how to do Wald test for week4, week8, week12 simultaneously?
```{r print-arthritis-gee-coef}
print(arthritis.gee.coef)
```
***
