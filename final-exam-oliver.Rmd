...
#TODO: Question asks for "independence working correlation matrix to describe the within-subject correlation structure (i.e. using the TYPE=IND on the REPEATED statement)" Update accordingly
