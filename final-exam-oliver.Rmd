...
Random intercepts:
$$
E(Y_{ij}) = \beta_{1} + \beta_{2} Month_{ij} + \beta_{3} Gender_{i} + \beta_{4} Freq_{i} + \beta_5 Gender_{i} \times Month_{ij} + \beta_6 Freq_{i} \times Month_{ij} + b_{1i}
$$

Random intercepts and slopes:
$$
E(Y_{ij}) = \beta_{1} + \beta_{2} Month_{ij} + \beta_{3} Gender_{i} + \beta_{4} Freq_{i} + \beta_5 Gender_{i} \times Month_{ij} + \beta_6 Freq_{i} \times Month_{ij} + b_{1i} + b_{2i} \times Month_{ij}
$$
