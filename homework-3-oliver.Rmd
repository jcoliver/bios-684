...
treatment.1 <- groupInfo(x = grip.data, treatment = 1)
treatment.2 <- groupInfo(x = grip.data, treatment = 2)
```
...
means.plot
```
Note error bars show $\pm \enspace 1SE$ where $SE = \sigma/\sqrt{n}$.

Both treatments indicate an increase in mean grip strength through time. Mean grip strength is continously increasing for treatment 1 subjects, although the rate of increase may be decreasing over time. In contrast, the increase in mean grip strength for treatment 2 subjects appears to happen within the first two weeks, then levels off after week 2.
