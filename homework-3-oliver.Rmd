...
<!-- Purpose: To provide an introduction to the analysis of response profiles for longitudinal -->
<!-- data. -->
...
### 7. Run an ANCOVA analysis of the outcomes (Y1, Y2, Y3), including the effects of week, treatment, and week X treatment as well as each subject’s baseline measurement as covariates. Compare both the week, treatment, and week X treatment effect estimates and standard errors to those from the profile analysis results from Q3. Explain why these results are the same or different from this earlier analysis.
