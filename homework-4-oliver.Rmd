...
#TODO: What is the difference between the estimates of parameter and the estimated matrices?

I start by comparing each model to the unstructured variance-covariance model (_ln(L)_ = `r round(var.models["un", "lnl"], 3)`). In all cases, log-likelihoods are from a REML model.

| Model | # Covariance Parameters | $ln(L)$ | $2\Delta ln(L)$ |
|:------|:-----------------------:|:-------:|:---------------:|
| `r var.models["cs", "model.name"]` | `r var.models["cs", "num.params"]` | `r round(var.models["cs", "lnl"], 3)` | `r round(2 * (var.models["un", "lnl"] - var.models["cs", "lnl"]), 3)` |
| `r var.models["hcs", "model.name"]` | `r var.models["hcs", "num.params"]` | `r round(var.models["hcs", "lnl"], 3)` | `r round(2 * (var.models["un", "lnl"] - var.models["hcs", "lnl"]), 3)` |
| `r var.models["ar", "model.name"]` | `r var.models["ar", "num.params"]` | `r round(var.models["ar", "lnl"], 3)` | `r round(2 * (var.models["un", "lnl"] - var.models["ar", "lnl"]), 3)` |
| `r var.models["har", "model.name"]` | `r var.models["har", "num.params"]` | `r round(var.models["har", "lnl"], 3)` | `r round(2 * (var.models["un", "lnl"] - var.models["har", "lnl"]), 3)` |
